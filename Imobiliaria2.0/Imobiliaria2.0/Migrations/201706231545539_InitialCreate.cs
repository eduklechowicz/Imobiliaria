    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Proprietarios", t => t.ProprietarioID, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        MatriculaImovel = c.String(nullable: false),
                        InscricaoImovel = c.String(nullable: false),
                        Ativo = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Propriedades", "ProprietarioID", "dbo.Proprietarios");
            ...
            DropIndex("dbo.Propriedades", new[] { "ProprietarioID" });
